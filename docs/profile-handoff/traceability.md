...
| *(audit)* hardcoded wins | D2 | Defect | V1 | `AC-V1-05` | [`T-AC-V1-05`](tests/e2e/V1-me-dashboard.spec.ts) | off | `IMG-V1-b` |
...
| Host status should display on profile | [G2](findings.md#g2--host-role-never-appears-on-a-profile) | Gap | V2 | `AC-V2-01` | [`T-AC-V2-01`](tests/e2e/V2-me-social-profile.spec.ts) | on | `IMG-V2-a` |
...
| --- | --- |
| Findings | 22 |
| Acceptance criteria | 41 (38 from findings, 3 regression guards) |
| Automated | 34 |
| Visual | 5 |
| Written decision only | 5 |
| Blocked on a policy document | 3 (`AC-V7-03`, `04`, `05`, all gated on `AC-V7-06`) |

Counts overlap: `AC-V3-01` is proven by both a unit test and an e2e spec, and
`AC-V8-04` needs a passing request test *and* a visual check.
